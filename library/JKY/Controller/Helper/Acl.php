 ...
 */
class          JKY_Controller_Helper_Acl 
extends        Zend_Controller_Action_Helper_Abstract {
      ...
      * @return JKY_Controller_Helper_Acl
      */
     public function setIdentity( $identity ) {
          ...
          } elseif( !$identity instanceof Zend_Acl_Role_Interface   ) { throw new Spindle_Model_Exception( 'Invalid identity provided' );
          }
