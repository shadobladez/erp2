 ...
 */
abstract class JKY_Model_Abstract 
implements     JKY_Model_Interface {
     ...
     */
      ...
      *
      * @param string $name
      * @return JKY_Model_Resource_Interface 
      */
     public function getResource( $name )  {
          if( !isset( $this->_resources[ $name ])) {
               $class = join( '_', array( $this->_getNamespace(), 'Resource', $this->_getInflected( $name )));
     ...
     public function getForm( $name ) {
          if( !isset( $this->_forms[ $name ])) {
               $class = join( '_', array( $this->_getNamespace(), 'Form', $this->_getInflected( $name )));
      ...
      * 
      * @param JKY_Model_Cache_Abstract $cache
      */
     public function setCache( JKY_Model_Cache_Abstract $cache ) {
          $this->_cache = $cache;
     }
      ...
      * @return JKY_Model_Cache_Abstract 
      */
     public function getCached( $tagged = null ) {
          if(  null === $this->_cache ) {
               $this->_cache = new JKY_Model_Cache( $this, $this->getCacheOptions(), $tagged );
          }
