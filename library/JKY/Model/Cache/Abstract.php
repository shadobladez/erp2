 ...
 */
abstract class JKY_Model_Cache_Abstract {
      ...
      * Constructor 
      * 
      * @param JKY_Model_Abstract $model
      * @param array|Zend_Config $options 
      */
     public function __construct( JKY_Model_Abstract $model, $options, $tagged = null ) {
          $this->_model = $model;
     ...
     public function __call( $method, $params ) {
          if( !is_callable( array( $this->_model, $method ))) {
               throw new JKY_Model_Exception( 'Method ' . $method . ' does not exist in class ' . get_class( $this->_model ));
          }
          $cache = $this->getCache();
