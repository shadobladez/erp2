<?php
/**
 * JKY_Model_Resource_Db_Table_Row_Abstract
 * 
 * Composite the Zend_Db_Table_Row
 * 
 * @category   iAds
 * @package    Iads_Model_Resource
 * @copyright  Copyright (c) 2008 Keith Pope (http://www.thepopeisdead.com)
 * @license    http://www.thepopeisdead.com/license.txt     New BSD License
 */
abstract class JKY_Model_Resource_Db_Table_Row_Abstract {
     ...
     public function setRow( array $config=array() ) {
          ...
          throw new JKY_Model_Exception( 'Could not set rowClass in ' . __CLASS__ );
     }
